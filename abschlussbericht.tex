...
\begin{document}
	...
	\begin{titlepage}
		...
		% \\[1cm]
		\centering
		{\huge \textbf{Der Crawler}}\\~\\ % two line breaks
		{\LARGE \textbf{Ein Reinforcement-Learning-Krabbelroboter}}
		\par

		\vfill
		% {\Large \textbf{Thema der Arbeit}} \\[2cm]

		\includegraphics[width=\textwidth, keepaspectratio]{photos/crawler_deckblatt.png}
	...
	\input{sections/abstract-und-einleitung}
	\input{sections/grundlagen}
	\input{sections/konzeption}
	\input{sections/umsetzung} % Ergebnisse, JuFo
