...
Das neue mechanische Konzept führte zu einem funktionsfähigen Chassis, das die Anforderungen an Modularität und Gewicht deutlich besser erfüllt als das Vorgängermodell. Tabelle \ref{tab:vergleich-hardware} fasst die wichtigsten Verbesserungen der Hardware zusammen.
...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{ X l l l }
        ...
        \addlinespace
        Materialeffizienz & Plexiglas & Infill-optimierter 3D-Druck & Ressourcenschonend \\
        \addlinespace
        Akkuwechsel (Zeit) & 2 min & 30 s & -75\,\% \\
        Bauteilwechsel (Zeit), z.B. Drehzahlsensor & ca. 30 min - 1 h & ca. 5 min & wartungsfreundlich \\
		\bottomrule
	\end{tabularx}
...
Die Software ist in einigen Aspekten verbessert, etwa ist sie insgesamt durch die strenge Kapselung und klar definierte Schnittstellen merklich robuster, insbesondere in der kollaborativen Entwicklung. Die Separation der für Hardware zuständigen ROS-Nodes bieten die Möglichkeit einer virtuellen Arbeitsumgebung ohne physische Hardware zum Entwicklen von Teilen der Software. Die tatsächliche Nutzung von WebSockets in der Web-API-Node erlaubt eine Echtzeitüberwachung sowie eine unkomplizierte Erweiterbarkeit in der Zukunft. Durch den hohen Abstraktionsgrad ist Q-Learning-Algorithmus problemlos austauschbar. 

Das Webinterface ist von Grund auf neu implementiert als moderne Web-App und bietet eine flüssige und visuell ansprechende Benutzererfahrung, die für Demonstrationen geeignet ist. Durch Farbcodierungen und Hervorhebungen ist den Visualisierungen auch bei schlechter Projektorqualität leicht zu folgen. Zusätzlich bietet das Webinterface neue hilfreiche Funktionen für das Durchführen von Versuchen wie das manuelle Lernen mit der Aktionsauswahl oder den Export bzw. Import von Modellen. 