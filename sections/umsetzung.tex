...
Die Software ist in einigen Aspekten verbessert, etwa ist sie insgesamt durch die strenge Kapselung und klar definierte Schnittstellen merklich robuster, insbesondere in der kollaborativen Entwicklung. Die separierten Hardware-Nodes biete die Möglichkeit einer virtuellen Arbeitsumgebung ohne physische Hardware zum Entwickeln von Teilen der Software. Die tatsächliche Nutzung von WebSockets in der Web-API-Node erlaubt eine Echtzeitüberwachung sowie eine unkomplizierte Erweiterbarkeit in der Zukunft. Durch den hohen Abstraktionsgrad ist der Q-Learning-Algorithmus problemlos austauschbar. 
