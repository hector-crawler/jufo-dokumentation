...
Die zentrale Fragestellung nach der Umsetzbarkeit einer anschaulichen Demonstrationsplattform für Reinforcement Learning konnte im Rahmen dieses Projeks weitgehend positiv beantwortet werden: Der Crawler ist in der Lage, durch Q-Learning eine stabile Vorwärtsbewegung zu erlernen, auch wenn er aktuell \glqq menschliche Hilfe\grqq \ beim Training benötigt. Dennoch macht das Webinterface den Lernprozess nachvollziehbar, was den Black-Box-Charakter von KI-Algorithmen verringert. 

\textbf{Ausblick}

Für die zukünftige Weiterentwicklung des Projekts bieten sich verschiedene Ansätze an. Mechanisch könnte der Roboter weiter optimiert werden, um Gewicht und Stabilität zu verbessern. Softwareseitig wäre die Implementierung fortgeschrittener Lernalgorithmen denkbar, um unterschiedliche Algorithmen vergleichen zu können und den Lerneffekt zu verbessern. Außerdem könnte eine physikalische Simulationsumgebung (z.B. mit Gazebo) genutzt werden, um Modelle vorab zu trainieren und damit die Verschleißung der physikalischen Komponenten zu minimieren und die Trainingszeit zu verkürzen.
