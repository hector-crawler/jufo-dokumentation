...
Im einem simplem Beispiel sähen Type Hints folgendermaßen aus:
...
Die hinzugefügten Type Hints geben an, dass die Variable \texttt{s} vom Typ String sein muss, sowie, dass die \texttt{greet}-Funktion einen String als Output produziert. Statt einem \texttt{TypeError} zur Laufzeit wird nun eine entsprechende Warning im Codeeditor angezeigt. 
